                ...
                <div className="relative z-10 flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6 h-full">
                    ...
                    <div className="flex flex-col gap-5 h-full">
                        ...
                        <div className="w-full sm:w-auto flex flex-col sm:flex-row gap-3">
                            ...
                            {/* TODO: Link to Invest page logic */}
                            <Button variant="secondary" className="!px-6 group opacity-50 cursor-not-allowed" disabled>
                                <span className="group-hover:text-white transition-colors">Claim</span>
                            </Button>
