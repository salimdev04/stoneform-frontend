        ...
        >
            {variant === "primary" && (
                <>
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-[#00c9ff] to-[#007cf0] opacity-100 transition-opacity" />

                    {/* Inner Glow/Border Effect */}
                    <div className="absolute inset-[1px] rounded-full border border-white/20 bg-gradient-to-r from-[#00c9ff] to-[#007cf0] -z-10" />
                </>
            )}
